...
plt.plot(x_graf,P_graf, color='orange', linestyle='-', marker='', label='Linea de burbuja')
plt.plot(y_graf,P_graf, color='green', linestyle='-', marker='', label='Linea de rocio')
plt.legend(loc=0)
plt.title('DIAGRAMA DE PRESION DE BURBUJA ', color='k', size='20') 
